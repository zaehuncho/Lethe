...
def test_cmake_sources_exist_and_bcrypt_is_resolved_dynamically() -> None:
    ...
    The current runtime resolves ``BCryptGenRandom`` dynamically, so this test
    pins the source/link contract as implemented. It does not claim that hiding
    imports is a release security control.
    """
