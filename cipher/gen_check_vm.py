#!/usr/bin/env python3
"""
gen_check_vm.py -- emit + verify the VIRTUALIZED password check as Daedalus VM
bytecode (Logic Mortaring for the crackme).

Instead of a native FNV->XOR check that any decompiler reads off, the crackme's
gate runs inside the Daedalus VM: an analyst who fully unpacks the binary sees the
...
from daedalus_ref import RefVM, _LOCAL_BASE  # noqa: E402
...
if __name__ == "__main__":
    ...
    if ok:
        ...
        hdr = (
            ...
            " * check runs as Daedalus VM bytecode (Logic Mortaring), XOR-obfuscated.*/\n"
            "#pragma once\n"
